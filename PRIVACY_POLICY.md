...
upload anything to our servers (we operate none).

## Local-only traffic handling
While a proxy toggle is ON, the app relays the network connections you send
through it (destination hosts, ports, byte counts) purely in device memory to
operate the proxy and show the traffic meter, chart, and recent-connections
...
## Changes
Material changes will be reflected in the Play listing and in this file.
